 ...
 *  の責任を負わない．
 * 
 *  @(#) $Id: target_sil.h 427 2009-10-07 02:08:49Z ertl-honda $
 */

/*
 *  sil.hのターゲット依存部（NIOS2_DEV用）
 *
...
/*
 *  SIL_LOC_SPNで用いるMutexのベースアドレス
 */
#ifdef TOPPERS_NIOS2_DEV_1S40
#define TOPPERS_SIL_MUTEX_BASE 0x07110300
#elif defined(TOPPERS_NIOS2_DEV_3C25)
#define TOPPERS_SIL_MUTEX_BASE 0x08000300
#elif defined(TOPPERS_NIOS2_DEV_3C120)
#define TOPPERS_SIL_MUTEX_BASE 0x0c021200
