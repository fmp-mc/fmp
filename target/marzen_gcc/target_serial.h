 ...
 *  の責任を負わない．
 * 
 *  $Id: target_serial.h 943 2012-10-19 07:50:40Z ertl-honda $
 */
 ...
 */
#if SCIF_NO == 2
#define INHNO_SIO     (0x10000 | IRQNO_SCIF2) 	/* 割込みハンドラ番号 */
#define INTNO_SIO     IRQNO_SCIF2				/* 割込み番号 */
#else /* SCIF_NO == 4 */
#define INHNO_SIO     (0x10000 | IRQNO_SCIF4) 	/* 割込みハンドラ番号 */
#define INTNO_SIO     IRQNO_SCIF4				/* 割込み番号 */
#endif /* SCIF_NO == 2 */

#ifdef TOPPERS_SAFEG_SECURE
#define INTPRI_SIO0       (-19)         				/* 割込み優先度 */
