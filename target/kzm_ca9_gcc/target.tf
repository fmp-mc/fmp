...
$INTNO_VALID = { 
	...
	0x00020,0x00021,...,0x000ff
}$

$INHNO_VALID = { 
	0x10000,0x10001,...,0x1000f;0x1001d,0x1001e,...,0x100ff;
	0x20000,0x20001,...,0x2000f;0x2001d,0x2001e,...,0x200ff;
	0x30000,0x30001,...,0x3000f;0x3001d,0x3001e,...,0x300ff;
	0x40000,0x40001,...,0x4000f;0x4001d,0x4001e,...,0x400ff
}$
