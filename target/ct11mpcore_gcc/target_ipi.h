 ...
 *  の責任を負わない．
 * 
 *  @(#) $Id: target_ipi.h 946 2012-10-19 08:26:37Z ertl-honda $
 */

/*
 *  プロセッサ間割込みドライバ（CT11MPCORE用）
 */
...
/*
 *  ディスパッチ要求用のプロセッサ間割込みの割込み優先度
 */
#define INTPRI_IPI_DIS_PRC1   (-1)
#define INTPRI_IPI_DIS_PRC2   (-1)
#define INTPRI_IPI_DIS_PRC3   (-1)
#define INTPRI_IPI_DIS_PRC4   (-1)

/*
 *  カーネル終了用のプロセッサ間割込みの割込み優先度
 */
