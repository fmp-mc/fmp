 ...
 *  の責任を負わない．
 *
 *  @(#) $Id: target_config.c 1025 2013-08-21 07:14:00Z ertl-honda $
 */
...
#if TNUM_PRCID >= 2
	sil_wrw_mem((void*)0xFFFFFFF0, (uint32_t)start);
	Asm("sev":::"memory");
#endif /* TNUM_PRCID >= 2 */
 ...
 */
extern void xuartps_pol_putc(char_t c);
...
#endif /* defined(TOPPERS_SAFEG_SECURE) || defined(TOPPERS_NOSAFEG) */
