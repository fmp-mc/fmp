 ...
 *  低レベル出力で使用するポート番号
 */
static const uint32_t prc_fput_log_uart_table[4] = {
	1,
	2,
	3,
	4
...
target_mprc_initialize(void)
{
	...
	sil_wrw_mem((void *)C2STBCR,
                (sil_rew_mem((void *)C2STBCR) | CSTBCR_LIGHT_SLEEP));
	sil_wrw_mem((void *)C3STBCR,
                (sil_rew_mem((void *)C3STBCR) | CSTBCR_LIGHT_SLEEP));
}
