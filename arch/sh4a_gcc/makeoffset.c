 ...
 *  の責任を負わない．
 * 
 *  @(#) $Id: makeoffset.c 512 2010-02-01 05:33:27Z ertl-honda $
 */
...
makeoffset(void)
{
	...
	OFFSET_DEF2(PCB, target_pcb.lock_flag, lock_flag);
	OFFSET_DEF2(PCB, target_pcb.saved_iipm, saved_iipm);
...
TCB	BIT_BB_TCB_enatex = {
	...
	NULL,					/* p_tinib */
	0U,						/* tstat */
#ifdef TOPPERS_EXTENSION_MUTEX
	0U,						/* bpriority */
#endif /* TOPPERS_EXTENSION_MUTEX */
	0U,						/* priority */
	false,					/* acqeue */
	false,					/* wupque */
	true,					/* enatex */
