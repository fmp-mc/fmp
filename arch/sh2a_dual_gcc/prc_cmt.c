 ...
 *	の責任を負わない．
 * 
 *  $Id: prc_cmt.c 867 2011-08-09 05:53:10Z mit-kimai $
 */
...
{
	/* CMT0スタート */
	sil_orh_reg((uint16_t *)CMSTR_01_h, CMSTR_STR0);
}
...
{
	/* CMT0停止 */
	sil_anh_reg((uint16_t *)CMSTR_01_h, ~CMSTR_STR0);
}
...
#ifndef OMIT_TARGET_TIMER_HANDLER
/*
 *	タイマ割込みハンドラ
 */
void
...
#endif	/*  OMIT_TARGET_TIMER_HANDLER  */
