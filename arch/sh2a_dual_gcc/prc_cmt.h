 ...
 *  の責任を負わない．
 * 
 *  $Id: prc_cmt.h 816 2011-06-30 02:46:57Z mit-kimai $
 */
 ...
 */
											/* 割込みハンドラ番号 */
#define INHNO_TIMER_SYSTIM	(CMI0_VECTOR | (TOPPERS_SYSTIM_PRCID << 16))
#define INTNO_TIMER_SYSTIM	INHNO_TIMER_SYSTIM	/* 割込み番号 */
