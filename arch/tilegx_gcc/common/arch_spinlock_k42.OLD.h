...
static inline
void k42_lock(k42lock *l, bool_t preemption)
{
	k42lock me;
	k42lock *pred, *succ;
	me.next = NULL;
...
#if defined(K42_SPIN_LOCK)

typedef k42lock LOCK __attribute__((aligned(CHIP_L2_LINE_SIZE()))) /*TODO: __attribute__((aligned(CHIP_L2_LINE_SIZE())))?*/;
