 ...
 *  の責任を負わない．
 * 
 *  @(#) $Id: test_mact_tsk2.h 308 2009-07-08 03:19:04Z ertl-honda $
 */


/* 
 *		mact_tskサービスコールのテスト(2)
 */
...
extern void	task2_4(intptr_t exinf);
extern void	task2_7(intptr_t exinf);
extern void	task2_finish(intptr_t exinf);
