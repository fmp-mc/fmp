...
namespace toppers
{
  namespace itronx
  {
    ...
    void cfg1_out::load_srec()
    {
      ...
      std::cout << "magic[0]:" << std::hex << magic[ 0 ] << std::endl;
    std::cout << "magic[1]:" << std::hex << magic[ 1 ] << std::endl;
    std::cout << "magic[2]:" << std::hex << magic[ 2 ] << std::endl;
    std::cout << "magic[3]:" << std::hex << magic[ 3 ] << std::endl;
#endif
