...
/**
 * SUPPORT_MANY_CORE_AFFINITY unlimits the core number restriction
 */
#if defined(SUPPORT_MANY_CORE_AFFINITY)
// TODO: uint32_t is a workaround for configurator bug, should use uint_t in the future
#define AFFINITY_MASK_SLICE_BITS (sizeof(uint32_t) * 8)
#define AFFINITY_MASK_SLICE_NUM  (TNUM_PRCID + AFFINITY_MASK_SLICE_BITS - 1) / AFFINITY_MASK_SLICE_BITS
#ifndef TOPPERS_MACRO_ONLY
typedef uint32_t afmsk_t[AFFINITY_MASK_SLICE_NUM];
#endif
#endif
