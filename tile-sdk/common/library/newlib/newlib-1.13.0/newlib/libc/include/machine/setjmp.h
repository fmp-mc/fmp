#ifndef	_MACHSETJMP_H_
#define	_MACHSETJMP_H_
...
#ifdef __tile__
/* 26 GPRs, r30 through r55 inclusive, plus ICS, plus some slack. */
#include <arch/abi.h>
#define _JBLEN 32
#define _JBTYPE uint_reg_t
#endif
...
#if defined(__CYGWIN__) || defined(__rtems__) || defined(__tile__)
#include <signal.h>
